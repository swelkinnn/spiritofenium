...
public class AncientForestBiome extends SoeModElements.ModElement {
	public static Biome biome;
	public AncientForestBiome(SoeModElements instance) {
		super(instance, 822);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-16764058).setWaterFogColor(-10066330)
						.withSkyColor(7972607).withFoliageColor(-16764160).withGrassColor(-16764160)
						.setParticle(new ParticleEffectAmbience(GhostbloodParticle.particle, 0.005f)).build();
				...
				mobSpawnInfo.withSpawner(EntityClassification.AMBIENT, new MobSpawnInfo.Spawners(TheLostEntity.entity, 20, 1, 4));
				...
				event.getRegistry().register(biome.setRegistryName("soe:ancient_forest"));
			}
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		BiomeDictionary.addTypes(RegistryKey.getOrCreateKey(Registry.BIOME_KEY, WorldGenRegistries.BIOME.getKey(biome)), BiomeDictionary.Type.FOREST,
				BiomeDictionary.Type.COLD, BiomeDictionary.Type.SPARSE, BiomeDictionary.Type.WET, BiomeDictionary.Type.DEAD,
