...
public class CrumblingBarkSlabBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:crumbling_bark_slab")
	public static final Block block = null;
	public CrumblingBarkSlabBlock(SoeModElements instance) {
		super(instance, 527);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("crumbling_bark_slab");
		}
