...
public class CactusFenceGateBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:cactus_fence_gate")
	public static final Block block = null;
	public CactusFenceGateBlock(SoeModElements instance) {
		super(instance, 517);
	}
