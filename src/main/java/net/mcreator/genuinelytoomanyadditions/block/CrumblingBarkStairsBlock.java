...
public class CrumblingBarkStairsBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:crumbling_bark_stairs")
	public static final Block block = null;
	public CrumblingBarkStairsBlock(SoeModElements instance) {
		super(instance, 526);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("crumbling_bark_stairs");
		}
