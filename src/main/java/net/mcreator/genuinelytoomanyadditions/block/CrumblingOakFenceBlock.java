...
public class CrumblingOakFenceBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:crumbling_oak_fence")
	public static final Block block = null;
	public CrumblingOakFenceBlock(SoeModElements instance) {
		super(instance, 498);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("crumbling_oak_fence");
		}
