...
public class Gingerbread_blocksSlabBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:gingerbread_blocks_slab")
	public static final Block block = null;
	public Gingerbread_blocksSlabBlock(SoeModElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("gingerbread_blocks_slab");
		}
