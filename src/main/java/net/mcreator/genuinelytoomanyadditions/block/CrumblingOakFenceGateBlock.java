...
public class CrumblingOakFenceGateBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:crumbling_oak_fence_gate")
	public static final Block block = null;
	public CrumblingOakFenceGateBlock(SoeModElements instance) {
		super(instance, 499);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("crumbling_oak_fence_gate");
		}
