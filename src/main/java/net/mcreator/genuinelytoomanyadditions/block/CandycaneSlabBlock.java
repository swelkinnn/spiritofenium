...
public class CandycaneSlabBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:candycane_slab")
	public static final Block block = null;
	public CandycaneSlabBlock(SoeModElements instance) {
		super(instance, 97);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("candycane_slab");
		}
