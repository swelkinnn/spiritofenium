...
public class Gingerbread_blocksFenceBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:gingerbread_blocks_fence")
	public static final Block block = null;
	public Gingerbread_blocksFenceBlock(SoeModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("gingerbread_blocks_fence");
		}
