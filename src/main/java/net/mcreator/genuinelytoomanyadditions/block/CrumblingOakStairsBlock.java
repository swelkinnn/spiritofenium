...
public class CrumblingOakStairsBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:crumbling_oak_stairs")
	public static final Block block = null;
	public CrumblingOakStairsBlock(SoeModElements instance) {
		super(instance, 496);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("crumbling_oak_stairs");
		}
