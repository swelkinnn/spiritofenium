...
public class WendigoPendantItemInInventoryTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (entity instanceof LivingEntity)
			((LivingEntity) entity).addPotionEffect(new EffectInstance(WendigoCursePotionEffect.potion, (int) 60, (int) 0, (false), (false)));
	}
}
