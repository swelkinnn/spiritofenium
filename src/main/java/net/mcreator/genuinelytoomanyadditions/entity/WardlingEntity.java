...
import net.mcreator.genuinelytoomanyadditions.procedures.WardlingOnInitialEntitySpawnProcedure;
import net.mcreator.genuinelytoomanyadditions.procedures.WardlingOnEntityTickUpdateProcedure;
import net.mcreator.genuinelytoomanyadditions.itemgroup.GTMMobsItemGroup;
import net.mcreator.genuinelytoomanyadditions.entity.renderer.WardlingRenderer;
...
public class WardlingEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(16).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("wardling").setRegistryName("wardling");
	public WardlingEntity(SoeModElements instance) {
		super(instance, 726);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WardlingRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16764109, -13421773, new Item.Properties().group(GTMMobsItemGroup.tab))
				.setRegistryName("wardling_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, WraithEntity.CustomEntity.class, true, false));
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				WardlingOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("entity", entity);
				$_dependencies.put("world", world);
				WardlingOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
