...
import net.mcreator.genuinelytoomanyadditions.entity.renderer.GrimmkinMasterRenderer;
import net.mcreator.genuinelytoomanyadditions.SoeModElements;

import java.util.Random;

@SoeModElements.ModElement.Tag
public class GrimmkinMasterEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("grimmkin_master").setRegistryName("grimmkin_master");
	public GrimmkinMasterEntity(SoeModElements instance) {
		super(instance, 129);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GrimmkinMasterRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434880, -10092493, new Item.Properties().group(GTMMobsItemGroup.tab))
				.setRegistryName("grimmkin_master_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, ServerPlayerEntity.class, true, true));
