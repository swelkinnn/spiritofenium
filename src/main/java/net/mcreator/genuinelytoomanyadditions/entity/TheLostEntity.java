...
public class TheLostEntity extends SoeModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new BreakBlockGoal(Blocks.TORCH, this, 1, (int) 3));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Blocks.SKELETON_SKULL));
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (WraithlyMatterItem.block == stack.getItem())
				return true;
			return false;
		}
	}
