...
import net.mcreator.genuinelytoomanyadditions.entity.renderer.VioletGolemRenderer;
import net.mcreator.genuinelytoomanyadditions.SoeModElements;

@SoeModElements.ModElement.Tag
public class VioletGolemEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("violet_golem").setRegistryName("violet_golem");
	public VioletGolemEntity(SoeModElements instance) {
		super(instance, 554);
		FMLJavaModLoadingContext.get().getModEventBus().register(new VioletGolemRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6750004, -65281, new Item.Properties().group(GTMMobsItemGroup.tab))
				.setRegistryName("violet_golem_spawn_egg"));
	}
