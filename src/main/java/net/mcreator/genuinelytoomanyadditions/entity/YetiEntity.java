...
import net.mcreator.genuinelytoomanyadditions.entity.renderer.YetiRenderer;
import net.mcreator.genuinelytoomanyadditions.SoeModElements;

@SoeModElements.ModElement.Tag
public class YetiEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("yeti").setRegistryName("yeti");
	public YetiEntity(SoeModElements instance) {
		super(instance, 133);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -3355444, new Item.Properties().group(GTMMobsItemGroup.tab))
				.setRegistryName("yeti_spawn_egg"));
	}
