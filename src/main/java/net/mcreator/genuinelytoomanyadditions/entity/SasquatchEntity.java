...
import net.mcreator.genuinelytoomanyadditions.entity.renderer.SasquatchRenderer;
import net.mcreator.genuinelytoomanyadditions.SoeModElements;

@SoeModElements.ModElement.Tag
public class SasquatchEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("sasquatch").setRegistryName("sasquatch");
	public SasquatchEntity(SoeModElements instance) {
		super(instance, 132);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SasquatchRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -6737152, new Item.Properties().group(GTMMobsItemGroup.tab))
				.setRegistryName("sasquatch_spawn_egg"));
	}
