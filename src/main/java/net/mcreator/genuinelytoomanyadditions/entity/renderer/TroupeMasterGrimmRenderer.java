...
@OnlyIn(Dist.CLIENT)
public class TroupeMasterGrimmRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TroupeMasterGrimmEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgrimm2(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("soe:textures/grimm2.png");
					}
				};
			});
		}
