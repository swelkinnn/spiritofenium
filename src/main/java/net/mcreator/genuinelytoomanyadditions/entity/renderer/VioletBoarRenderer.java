...
@OnlyIn(Dist.CLIENT)
public class VioletBoarRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(VioletBoarEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpigclops(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("soe:textures/violet_boar.png");
					}
				};
			});
		}
