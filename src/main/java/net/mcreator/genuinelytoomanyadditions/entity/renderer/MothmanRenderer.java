...
@OnlyIn(Dist.CLIENT)
public class MothmanRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MothmanEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelmothman(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("soe:textures/mothman.png");
					}
				};
			});
		}
