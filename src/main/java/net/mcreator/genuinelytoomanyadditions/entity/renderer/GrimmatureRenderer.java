...
@OnlyIn(Dist.CLIENT)
public class GrimmatureRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GrimmatureEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgrimmature(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("soe:textures/grimmature.png");
					}
				};
			});
		}
