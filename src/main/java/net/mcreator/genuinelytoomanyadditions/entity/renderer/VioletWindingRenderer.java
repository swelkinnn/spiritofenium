...
@OnlyIn(Dist.CLIENT)
public class VioletWindingRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(VioletWindingEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwendigo_2(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("soe:textures/violet_wendigo_2.png");
					}
				};
			});
		}
