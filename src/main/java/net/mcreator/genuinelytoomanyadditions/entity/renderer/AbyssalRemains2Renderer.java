...
@OnlyIn(Dist.CLIENT)
public class AbyssalRemains2Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(AbyssalRemains2Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelabyssalremains2(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("soe:textures/abyssal_remains2.png");
					}
				};
			});
		}
