...
public class GrimmchildEntity extends SoeModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new TemptGoal(this, 1, Ingredient.fromItems(NightmareFlameItem.block), false));
			...
			this.goalSelector.addGoal(5, new TemptGoal(this, 1, Ingredient.fromItems(InfectedGlobuleItem.block), false));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(GrimmchildSummonerItem.block));
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (InfectedGlobuleItem.block == stack.getItem())
				return true;
			return false;
		}
