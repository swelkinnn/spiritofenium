...
import net.mcreator.genuinelytoomanyadditions.procedures.ReaverinfentitytickupdateProcedure;
import net.mcreator.genuinelytoomanyadditions.procedures.ReaverInfOnInitialEntitySpawnProcedure;
import net.mcreator.genuinelytoomanyadditions.entity.renderer.ReaverInfRenderer;
...
public class ReaverInfEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("reaver_inf").setRegistryName("reaver_inf");
	public ReaverInfEntity(SoeModElements instance) {
		super(instance, 901);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ReaverInfRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -16751002, -13408768, new Item.Properties().group(null)).setRegistryName("reaver_inf_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("world", world);
				ReaverinfentitytickupdateProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
