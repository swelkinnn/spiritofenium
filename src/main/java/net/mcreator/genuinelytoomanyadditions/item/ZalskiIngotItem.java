...
public class ZalskiIngotItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:zalski_ingot")
	public static final Item block = null;
	public ZalskiIngotItem(SoeModElements instance) {
		super(instance, 760);
	}
