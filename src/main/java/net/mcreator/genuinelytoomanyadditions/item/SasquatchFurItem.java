...
public class SasquatchFurItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:sasquatch_fur")
	public static final Item block = null;
	public SasquatchFurItem(SoeModElements instance) {
		super(instance, 108);
	}
