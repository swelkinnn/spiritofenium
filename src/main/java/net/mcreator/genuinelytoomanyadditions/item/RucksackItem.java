...
import net.mcreator.genuinelytoomanyadditions.gui.RucksackguiGuiWindow;
import net.mcreator.genuinelytoomanyadditions.gui.RucksackguiGui;
...
public class RucksackItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:rucksack")
	public static final Item block = null;
	public RucksackItem(SoeModElements instance) {
		super(instance, 845);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof RucksackguiGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Rucksack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new RucksackguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
