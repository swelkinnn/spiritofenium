...
public class MirrorMaskDrunkItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:mirror_mask_drunk_helmet")
	public static final Item helmet = null;
	@ObjectHolder("soe:mirror_mask_drunk_chestplate")
	public static final Item body = null;
	@ObjectHolder("soe:mirror_mask_drunk_leggings")
	public static final Item legs = null;
	@ObjectHolder("soe:mirror_mask_drunk_boots")
	public static final Item boots = null;
	public MirrorMaskDrunkItem(SoeModElements instance) {
		super(instance, 876);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(GTMArmorsItemGroup.tab)) {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A77Everyone here is so weird!"));
			}

			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "soe:textures/models/armor/ena_mask_drunk__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		...
		}.setRegistryName("mirror_mask_drunk_helmet"));
	}
}
