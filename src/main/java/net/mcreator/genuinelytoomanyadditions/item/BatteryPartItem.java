...
public class BatteryPartItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:battery_part")
	public static final Item block = null;
	public BatteryPartItem(SoeModElements instance) {
		super(instance, 102);
	}
