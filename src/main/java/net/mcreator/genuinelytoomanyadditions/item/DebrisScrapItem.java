...
public class DebrisScrapItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:debris_scrap")
	public static final Item block = null;
	public DebrisScrapItem(SoeModElements instance) {
		super(instance, 793);
	}
