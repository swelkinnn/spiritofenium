...
public class PigclopsToothItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:pigclops_tooth")
	public static final Item block = null;
	public PigclopsToothItem(SoeModElements instance) {
		super(instance, 105);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("pigclops_tooth");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Tier 1 Boss Drop"));
		}
	}
}
